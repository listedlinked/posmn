...
int nAnonymizeCarebitAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Carebit
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Carebit
    // Mac: ~/Library/Application Support/Carebit
    // Unix: ~/.Carebit
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Carebit";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Carebit.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Carebitd.pid"));
