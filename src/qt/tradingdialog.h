...
private slots:
    ...
    QString BuyCBT(QString OrderType, double Quantity, double Rate);
    QString SellCBT(QString OrderType, double Quantity, double Rate);
