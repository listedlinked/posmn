...
void BitcoinGUI::createActions()
{
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About Carebit"), this);
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #000000; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }"
		"QToolButton:hover { background-color: #d2dbe0; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #d2dbe0; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #d2dbe0; border: none; padding-top: 5px; padding-bottom: 5px; }"
